...
<head>
    <title>Laravel 10 Tasks App</title>
...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    ...
    <div x-data="{flash: true}">
        ...
        <div x-show="flash" class="relative mb-10 rounded border border-green-400 bg-green-100 px-4 py-3 text-green-800" role="alert">
